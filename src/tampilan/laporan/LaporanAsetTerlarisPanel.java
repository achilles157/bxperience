...
public class LaporanAsetTerlarisPanel extends JPanel {

    private JDateChooser dateFrom, dateTo;
    private JComboBox<String> filterJenis;
    ...
    public LaporanAsetTerlarisPanel() {
        ...
        JLabel titleLabel = new JLabel("LAPORAN ASET TERLARIS", SwingConstants.CENTER);
        ...
        controlPanel.add(new JLabel("Jenis Transaksi:"));
        filterJenis = new JComboBox<>(new String[] { "Semua", "Booking", "PlayAtHome" });
        UIStyle.styleComboBox(filterJenis);
        controlPanel.add(filterJenis);
        ...
        String[] columns = { "Peringkat", "Nama Aset", "Kategori", "Jumlah Disewa" };
    ...
    private void loadReportData() {
        ...
        new SwingWorker<List<Object[]>, Void>() {
            ...
            protected List<Object[]> doInBackground() throws Exception {
                String jenisFilter = filterJenis.getSelectedItem().toString();
                LaporanDAO dao = new LaporanDAO();
                return dao.getAsetTerlaris(dateFrom.getDate(), dateTo.getDate(), jenisFilter);
            }
            ...
            protected void done() {
                try {
                    ...
                    reportTable.getColumnModel().getColumn(1).setPreferredWidth(300); // Nama Aset
                    reportTable.getColumnModel().getColumn(2).setPreferredWidth(150); // Kategori
                    reportTable.getColumnModel().getColumn(3).setPreferredWidth(100); // Jumlah

                } catch (Exception e) {
                    e.printStackTrace();
                    UIStyle.showErrorMessage(LaporanAsetTerlarisPanel.this,
    ...
    private void downloadPDF() {
        ...
        fileChooser.setSelectedFile(
                new File("Laporan_Aset_Terlaris_" + new SimpleDateFormat("yyyyMMdd").format(new Date()) + ".pdf"));
        ...
        if (fileChooser.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                // Add Title
                Paragraph title = new Paragraph("Laporan Aset Terlaris",
                ...
                // Table Header
                String[] headers = { "Peringkat", "Nama Aset", "Kategori", "Jumlah Disewa" };
